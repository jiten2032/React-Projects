...
export default function Restaurants({ Mydata: info }) {


    const EachData = info.map(Data => {
        ...
        <div>
            <div className="container text-center">
                ...
                <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" onChange={handleChange} className="btn-check" name="name" id="btnradio1" value="4* & Above" autoComplete="off" />
                    <label className="btn btn-outline-success" htmlFor="btnradio1">4* & Above</label>

                    <input type="radio" onChange={handleChange} className="btn-check" name="name" id="btnradio2" value="3* & Above" autoComplete="off" />
                    <label className="btn btn-outline-success" htmlFor="btnradio2">3* & Above</label>

                    <input type="radio" onChange={handleChange} className="btn-check" name="name" id="btnradio3" value="2* & Above" autoComplete="off" />
                    <label className="btn btn-outline-success" htmlFor="btnradio3">2* & Above</label>

                    <input type="radio" onChange={handleChange} className="btn-check" name="name" id="btnradio4" value="Clear all" autoComplete="off" />
